        ...
        <section className={s.wrapper}>
            <div className={`content`}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div className={`${s.letter} ${s.p}`} style={{ marginTop: 0, display: 'grid', gap: '10px', textAlign: 'justify' }}>
                        ...
                        <div>
                            От вас требуется только прекрасное настроение на весь день!
                            Надеемся, что вы сможете присутствовать и поддержать нас в этот волшебный для нас день - день создания новой семьи! Просим, в ближайшее время,  дать ответ.
                        </div>
                        <div>
                            Очень ждем вас на нашей свадьбе!
                        </div>
